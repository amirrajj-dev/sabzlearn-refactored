...
import { SignInschemaType, schema } from "@/utils/schemas/signInSchema";
...
const SignIn = () => {
  ...
  const onSubmit = async (data: SignInschemaType) => {
    ...
    } else if (res.message === "User is banned") {
      toast.error("شما اجازه ورود ندارید", toastOptions);
    } else if (res.message === "User not found") {
      toast.error("کاربری با این ایمیل وجود ندارد", toastOptions);
    } else {
      toast.error("خطایی رخ داده است. لطفاً دوباره تلاش کنید.", toastOptions);
    }
  };
